...
public class FundingNotMatchedModel {
	...
	public String toString() {
		return "FundingNotMatchedModel{" +
				"fId=" + fId +
				", fInvestRecordId=" + fInvestRecordId +
				", fNotMatchedMoney=" + fNotMatchedMoney +
				", fFoundingType=" + fFoundingType +
				", fFoundingWeight=" + fFoundingWeight +
				", fIsLocked=" + fIsLocked +
